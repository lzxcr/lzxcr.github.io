---
title: "友情链接"
description: "与朋友们一起成长"
---

export const site = {
  name: "Jacobi Lie's Website",
  desc: "殚精竭虑，有晦渐开。",
  url: "https://lzxcr.github.io",
  avatar: "/favicon/favicon-light-128.png",
  email: "jssnlzxcr@gmail.com",
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">附上您的站点信息，确认后会尽快添加</p>
            </div>
          </div>
